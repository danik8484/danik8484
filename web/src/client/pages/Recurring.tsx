...
export default function Recurring() {
  ...
  return (
    <div>
      ...
      <p className="mb-3 text-sm text-slate-600">משימות שנוצרות אוטומטית בימים שנבחרו. משימה קבועה יושבת על הלוח עד שמסמנים "הושלם" (בלי עותק שני ובלי "נגררת"), ואחרי שהושלמה חוזרת נקייה ביום הבא. משימת לידים שונה: היא של היום שלה בלבד – מה שלא מולא אתמול לא נגרר, וכל יום יש "לידים" חדשה, כדי שהנסלקים יירשמו על היום שבו מילאו אותם.</p>
