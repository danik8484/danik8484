  ...
  return (
    <form onSubmit={submit} className="space-y-4">
      ...
      <p className="text-xs text-slate-500">
        מנהל ראשי רואה את כולם. מנהל רואה את עצמו ואת אנשי הצוות שהוא המנהל הישיר שלהם. איש צוות רואה רק את עצמו. רכז הוא איש צוות (עם לו"ז משלו ומנהל ישיר) שגם רואה את הלו"ז של כולם, כולל המנהל הראשי, ומוסיף משימות לכולם. אצל אחרים הוא לא משנה סטטוס ולא מצרף תמונות, חוץ מלמשימות שהוא עצמו הוסיף.
      </p>
      {user && !isSelf && (
